...
export type PlateRotationEditorProps = {
    slides: SlideAsset[];
    assets: MediaAsset[];
...
export function PlateRotationEditor({
    slides,
    assets,
    carousel,
    selectedSetId = null,
        ...
        <section className="surface-panel mb-5 overflow-hidden">
            <div className="border-b border-line p-4">
                <div className="flex flex-col gap-2 md:flex-row md:items-start md:justify-between">
                    <div>
                        <h2 className="text-sm font-semibold">Plate rotation</h2>
                        <p className="mt-1 max-w-3xl text-sm text-muted">
                            Build named rotations of ready plates and short promo videos. Save a
                            set, then choose it in Fallback policy.
                        </p>
                    </div>
                    <div className="flex flex-col gap-1 rounded-md border border-line bg-panel-soft px-3 py-2 text-xs font-semibold text-muted">
                        ...
                        <span>
                            ...
                            <span className="text-ink">
                                {selectedSetId
                                    ? (carousel?.sets.find((set) => set.id === selectedSetId)?.name ??
                                      selectedSetId)
                                    : 'None'}
                            </span>
                        </span>
