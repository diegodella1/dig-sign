        ...
        <AdminShell title="Operate">
            ...
            <BroadcastLayout
                                    ...
                                    return (
                                        ...
                                        >
                                            <div>
                                                ...
                                                {snapshot?.durationSeconds ? (
                                                    <p className="text-xs text-muted">
                                                        {formatTimecode(snapshot.elapsedSeconds ?? 0)} /{' '}
                                            ...
                                            <div className="flex flex-wrap gap-2">
                                                ...
                                                <a
                                                    href={liveOutputHrefForScreen(screen.slug, true)}
                                                    className="rounded-md border border-line px-3 py-1.5 text-sm"
                                                    target="_blank"
                                                    rel="noreferrer"
                                                >
                ...
                rail={
                    <>
                        <section className="rounded-md border border-line bg-surface-elevated-2 p-4">
                            <FormHeader title="Quick links" detail="Signage setup and monitoring." />
                            ...
                            <p className="mt-3 text-xs text-muted">
                                {readyPlaylists} ready playlist{readyPlaylists === 1 ? '' : 's'} ·{' '}
